...
This module provides the interface for invoking and authenticating various models, and offers Boss a unified information and credentials form rule for model providers.
