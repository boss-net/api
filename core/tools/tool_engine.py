...
from core.callback_handler.agent_tool_callback_handler import BossAgentCallbackHandler
from core.callback_handler.workflow_tool_callback_handler import BossWorkflowCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: BossAgentCallbackHandler,
    ...
    def generic_invoke(
        ...
        user_id: str,
        workflow_tool_callback: BossWorkflowCallbackHandler,
