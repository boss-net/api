...
class ProviderManager:
    ...
    def get_configurations(self, tenant_id: str) -> ProviderConfigurations:
        ...
        # append providers with boss-net/openai/openai
        ...
        for provider_entity in provider_entities:
            ...
            if is_filtered(
                include_set=cast(set[str], boss_config.POSITION_PROVIDER_INCLUDES_SET),
                exclude_set=cast(set[str], boss_config.POSITION_PROVIDER_EXCLUDES_SET),
            ...
            if provider_id_entity.is_boss - net():
