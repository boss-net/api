...
HTTP_REQUEST_DEFAULT_TIMEOUT = HttpRequestNodeTimeout(
    connect=boss_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
    read=boss_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
    write=boss_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
)
            ...
            "config": {
                ...
                "timeout": {
                    **HTTP_REQUEST_DEFAULT_TIMEOUT.model_dump(),
                    "max_connect_timeout": boss_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
                    "max_read_timeout": boss_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
                    "max_write_timeout": boss_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
                },
                "ssl_verify": boss_config.HTTP_REQUEST_NODE_SSL_VERIFY,
            },
            "retry_config": {
                "max_retries": boss_config.SSRF_DEFAULT_MAX_RETRIES,
