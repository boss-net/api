...
class HttpRequestNodeTimeout(BaseModel):
    connect: int = boss_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT
    read: int = boss_config.HTTP_REQUEST_MAX_READ_TIMEOUT
    write: int = boss_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT
...
class HttpRequestNodeData(BaseNodeData):
    ...
    ssl_verify: Optional[bool] = boss_config.HTTP_REQUEST_NODE_SSL_VERIFY
