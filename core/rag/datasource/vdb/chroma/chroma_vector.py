...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=boss_config.CHROMA_HOST or "",
                port=boss_config.CHROMA_PORT,
                tenant=boss_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=boss_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=boss_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=boss_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
