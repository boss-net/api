...
class MilvusVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            ...
            config=MilvusConfig(
                uri=boss_config.MILVUS_URI or "",
                token=boss_config.MILVUS_TOKEN or "",
                user=boss_config.MILVUS_USER or "",
                password=boss_config.MILVUS_PASSWORD or "",
                database=boss_config.MILVUS_DATABASE or "",
                enable_hybrid_search=boss_config.MILVUS_ENABLE_HYBRID_SEARCH or False,
                analyzer_params=boss_config.MILVUS_ANALYZER_PARAMS or "",
            ),
        )
