...
class BaiduVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaiduVector:
        ...
        return BaiduVector(
            ...
            config=BaiduConfig(
                endpoint=boss_config.BAIDU_VECTOR_DB_ENDPOINT or "",
                connection_timeout_in_mills=boss_config.BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS,
                account=boss_config.BAIDU_VECTOR_DB_ACCOUNT or "",
                api_key=boss_config.BAIDU_VECTOR_DB_API_KEY or "",
                database=boss_config.BAIDU_VECTOR_DB_DATABASE or "",
                shard=boss_config.BAIDU_VECTOR_DB_SHARD,
                replicas=boss_config.BAIDU_VECTOR_DB_REPLICAS,
            ),
        )
