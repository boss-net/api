    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> VastbaseVector:
        ...
        return VastbaseVector(
            ...
            config=VastbaseVectorConfig(
                host=boss_config.VASTBASE_HOST or "localhost",
                port=boss_config.VASTBASE_PORT,
                user=boss_config.VASTBASE_USER or "boss",
                password=boss_config.VASTBASE_PASSWORD or "",
                database=boss_config.VASTBASE_DATABASE or "boss",
                min_connection=boss_config.VASTBASE_MIN_CONNECTION,
                max_connection=boss_config.VASTBASE_MAX_CONNECTION,
            ),
        )
