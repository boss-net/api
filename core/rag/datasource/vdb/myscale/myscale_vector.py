    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=boss_config.MYSCALE_HOST,
                port=boss_config.MYSCALE_PORT,
                user=boss_config.MYSCALE_USER,
                password=boss_config.MYSCALE_PASSWORD,
                database=boss_config.MYSCALE_DATABASE,
                fts_params=boss_config.MYSCALE_FTS_PARAMS,
            ),
        )
