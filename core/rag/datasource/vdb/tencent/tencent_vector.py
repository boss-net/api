    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TencentVector:
        ...
        return TencentVector(
            ...
            config=TencentConfig(
                url=boss_config.TENCENT_VECTOR_DB_URL or "",
                api_key=boss_config.TENCENT_VECTOR_DB_API_KEY,
                timeout=boss_config.TENCENT_VECTOR_DB_TIMEOUT,
                username=boss_config.TENCENT_VECTOR_DB_USERNAME,
                database=boss_config.TENCENT_VECTOR_DB_DATABASE,
                shard=boss_config.TENCENT_VECTOR_DB_SHARD,
                replicas=boss_config.TENCENT_VECTOR_DB_REPLICAS,
                enable_hybrid_search=boss_config.TENCENT_VECTOR_DB_ENABLE_HYBRID_SEARCH or False,
            ),
        )
