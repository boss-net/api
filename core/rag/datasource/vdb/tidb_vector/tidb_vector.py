    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=boss_config.TIDB_VECTOR_HOST or "",
                port=boss_config.TIDB_VECTOR_PORT or 0,
                user=boss_config.TIDB_VECTOR_USER or "",
                password=boss_config.TIDB_VECTOR_PASSWORD or "",
                database=boss_config.TIDB_VECTOR_DATABASE or "",
                program_name=boss_config.APPLICATION_NAME,
            ),
        )
