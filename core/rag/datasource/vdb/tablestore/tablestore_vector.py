    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TableStoreVector:
        ...
        return TableStoreVector(
            ...
            config=TableStoreConfig(
                endpoint=boss_config.TABLESTORE_ENDPOINT,
                instance_name=boss_config.TABLESTORE_INSTANCE_NAME,
                access_key_id=boss_config.TABLESTORE_ACCESS_KEY_ID,
                access_key_secret=boss_config.TABLESTORE_ACCESS_KEY_SECRET,
            ),
        )
