    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                user=boss_config.ORACLE_USER or "system",
                password=boss_config.ORACLE_PASSWORD or "oracle",
                dsn=boss_config.ORACLE_DSN or "oracle:1521/freepdb1",
                config_dir=boss_config.ORACLE_CONFIG_DIR,
                wallet_location=boss_config.ORACLE_WALLET_LOCATION,
                wallet_password=boss_config.ORACLE_WALLET_PASSWORD,
                is_autonomous=boss_config.ORACLE_IS_AUTONOMOUS,
            ),
        )
