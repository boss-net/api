    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=boss_config.PGVECTOR_HOST or "localhost",
                port=boss_config.PGVECTOR_PORT,
                user=boss_config.PGVECTOR_USER or "postgres",
                password=boss_config.PGVECTOR_PASSWORD or "",
                database=boss_config.PGVECTOR_DATABASE or "postgres",
                min_connection=boss_config.PGVECTOR_MIN_CONNECTION,
                max_connection=boss_config.PGVECTOR_MAX_CONNECTION,
                pg_bigm=boss_config.PGVECTOR_PG_BIGM,
            ),
        )
