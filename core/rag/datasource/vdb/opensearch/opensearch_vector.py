...
class OpenSearchVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenSearchVector:
        ...
        open_search_config = OpenSearchConfig(
            host=boss_config.OPENSEARCH_HOST or "localhost",
            port=boss_config.OPENSEARCH_PORT,
            secure=boss_config.OPENSEARCH_SECURE,
            verify_certs=boss_config.OPENSEARCH_VERIFY_CERTS,
            auth_method=boss_config.OPENSEARCH_AUTH_METHOD.value,
            user=boss_config.OPENSEARCH_USER,
            password=boss_config.OPENSEARCH_PASSWORD,
            aws_region=boss_config.OPENSEARCH_AWS_REGION,
            aws_service=boss_config.OPENSEARCH_AWS_SERVICE,
        )
