    ...
    def init_vector(
        ...
        return OceanBaseVector(
            ...
            OceanBaseVectorConfig(
                host=boss_config.OCEANBASE_VECTOR_HOST or "",
                port=boss_config.OCEANBASE_VECTOR_PORT or 0,
                user=boss_config.OCEANBASE_VECTOR_USER or "",
                password=(boss_config.OCEANBASE_VECTOR_PASSWORD or ""),
                database=boss_config.OCEANBASE_VECTOR_DATABASE or "",
                enable_hybrid_search=boss_config.OCEANBASE_ENABLE_HYBRID_SEARCH or False,
            ),
        )
