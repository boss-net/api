    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenGauss:
        ...
        return OpenGauss(
            ...
            config=OpenGaussConfig(
                host=boss_config.OPENGAUSS_HOST or "localhost",
                port=boss_config.OPENGAUSS_PORT,
                user=boss_config.OPENGAUSS_USER or "postgres",
                password=boss_config.OPENGAUSS_PASSWORD or "",
                database=boss_config.OPENGAUSS_DATABASE or "boss",
                min_connection=boss_config.OPENGAUSS_MIN_CONNECTION,
                max_connection=boss_config.OPENGAUSS_MAX_CONNECTION,
                enable_pq=boss_config.OPENGAUSS_ENABLE_PQ or False,
            ),
        )
