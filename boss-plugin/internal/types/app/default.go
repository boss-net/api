...
func (config *Config) SetDefault() {
	...
	setDefaultInt(&config.BossInvocationConnectionIdleTimeout, 120)
	...
	setDefaultInt(&config.BossPluginServerlessConnectorLaunchTimeout, 240)
	...
	setDefaultInt(&config.BossInvocationWriteTimeout, 5000)
	setDefaultInt(&config.BossInvocationReadTimeout, 240000)
