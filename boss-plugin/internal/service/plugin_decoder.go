...
import (
	...
	"github.com/boss-net/api/boss-plugin/pkg/bundle_packager"
	"github.com/boss-net/api/boss-plugin/pkg/entities"
	"github.com/boss-net/api/boss-plugin/pkg/entities/bundle_entities"
...
func UploadPluginPkg(
	...
	c *gin.Context,
	tenantId string,
	bossPkgFile multipart.File,
	verifySignature bool,
) *entities.Response {
	pluginFile, err := io.ReadAll(bossPkgFile)
	if err != nil {
...
func UploadPluginBundle(
	...
	c *gin.Context,
	tenant_id string,
	boss_bundle_file multipart.File,
	verify_signature bool,
) *entities.Response {
	bundleFile, err := io.ReadAll(boss_bundle_file)
	if err != nil {
		return exception.InternalServerError(err).ToResponse()
	}
