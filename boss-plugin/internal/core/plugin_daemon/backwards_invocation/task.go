...
import (
	...
	"github.com/boss-net/api/boss-plugin/internal/core/persistence"
...
func InvokeBoss(
	...
	requestHandle, err := prepareBossInvocationArguments(
		session,
		writer,
		request,
	)
	...
	if invoke_from == access_types.PLUGIN_ACCESS_TYPE_MODEL {
		requestHandle.WriteError(fmt.Errorf("you can not invoke boss from %s", invoke_from))
	...
	routine.Submit(map[string]string{
		...
		dispatchBossInvocationTask(requestHandle)
...
var (
	permissionMapping = map[boss_invocation.InvokeType]map[string]any{
		boss_invocation.INVOKE_TYPE_TOOL: {
		...
		boss_invocation.INVOKE_TYPE_LLM: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_TEXT_EMBEDDING: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_RERANK: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_TTS: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_SPEECH2TEXT: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_MODERATION: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_NODE_PARAMETER_EXTRACTOR: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_NODE_QUESTION_CLASSIFIER: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
				return declaration.Resource.Permission.AllowInvokeNode()
			},
			"error": "permission denied, you need to enable node access in plugin manifest",
		},
		boss_invocation.INVOKE_TYPE_APP: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_STORAGE: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
		...
		boss_invocation.INVOKE_TYPE_SYSTEM_SUMMARY: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
				return declaration.Resource.Permission.AllowInvokeLLM()
			},
			"error": "permission denied, you need to enable llm access in plugin manifest",
		},
		boss_invocation.INVOKE_TYPE_UPLOAD_FILE: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
				return true
			},
			"error": "permission denied, you need to enable storage access in plugin manifest",
		},
		boss_invocation.INVOKE_TYPE_FETCH_APP: {
			"func": func(declaration *plugin_entities.PluginDeclaration) bool {
				return declaration.Resource.Permission.AllowInvokeApp()
			},
			"error": "permission denied, you need to enable app access in plugin manifest",
...
func prepareBossInvocationArguments(
	session *session_manager.Session,
	writer BackwardsInvocationWriter,
...
var (
	dispatchMapping = map[boss_invocation.InvokeType]func(handle *BackwardsInvocation){
		boss_invocation.INVOKE_TYPE_TOOL: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationToolTask)
		},
		boss_invocation.INVOKE_TYPE_LLM: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationLLMTask)
		},
		boss_invocation.INVOKE_TYPE_TEXT_EMBEDDING: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationTextEmbeddingTask)
		},
		boss_invocation.INVOKE_TYPE_RERANK: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationRerankTask)
		},
		boss_invocation.INVOKE_TYPE_TTS: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationTTSTask)
		},
		boss_invocation.INVOKE_TYPE_SPEECH2TEXT: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationSpeech2TextTask)
		},
		boss_invocation.INVOKE_TYPE_MODERATION: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationModerationTask)
		},
		boss_invocation.INVOKE_TYPE_APP: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationAppTask)
		},
		boss_invocation.INVOKE_TYPE_NODE_PARAMETER_EXTRACTOR: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationParameterExtractor)
		},
		boss_invocation.INVOKE_TYPE_NODE_QUESTION_CLASSIFIER: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationQuestionClassifier)
		},
		boss_invocation.INVOKE_TYPE_STORAGE: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationStorageTask)
		},
		boss_invocation.INVOKE_TYPE_SYSTEM_SUMMARY: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationSystemSummaryTask)
		},
		boss_invocation.INVOKE_TYPE_UPLOAD_FILE: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationUploadFileTask)
		},
		boss_invocation.INVOKE_TYPE_FETCH_APP: func(handle *BackwardsInvocation) {
			genericDispatchTask(handle, executeBossInvocationFetchAppTask)
		},
	}
)
...
func dispatchBossInvocationTask(handle *BackwardsInvocation) {
...
func executeBossInvocationToolTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeToolRequest,
) {
...
func executeBossInvocationLLMTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeLLMRequest,
) {
...
func executeBossInvocationTextEmbeddingTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeTextEmbeddingRequest,
) {
...
func executeBossInvocationRerankTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeRerankRequest,
) {
...
func executeBossInvocationTTSTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeTTSRequest,
) {
...
func executeBossInvocationSpeech2TextTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeSpeech2TextRequest,
) {
...
func executeBossInvocationModerationTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeModerationRequest,
) {
...
func executeBossInvocationAppTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeAppRequest,
) {
...
func executeBossInvocationParameterExtractor(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeParameterExtractorRequest,
) {
...
func executeBossInvocationQuestionClassifier(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeQuestionClassifierRequest,
) {
...
func executeBossInvocationStorageTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeStorageRequest,
) {
	...
	if request.Opt == boss_invocation.STORAGE_OPT_GET {
	...
	} else if request.Opt == boss_invocation.STORAGE_OPT_SET {
	...
	} else if request.Opt == boss_invocation.STORAGE_OPT_DEL {
	...
	} else if request.Opt == boss_invocation.STORAGE_OPT_EXIST {
...
func executeBossInvocationSystemSummaryTask(
	handle *BackwardsInvocation,
	request *boss_invocation.InvokeSummaryRequest,
) {
...
func executeBossInvocationUploadFileTask(
	handle *BackwardsInvocation,
	request *boss_invocation.UploadFileRequest,
) {
...
func executeBossInvocationFetchAppTask(
	handle *BackwardsInvocation,
	request *boss_invocation.FetchAppRequest,
) {
