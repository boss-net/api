...
import (
	...
	cloudoss "github.com/boss-net/api/cloud/oss"
...
var defaultConfig = &app.Config{
	DBType:     "postgresql",
	DBUsername: "postgres",
	DBPassword: "bossai123456",
	DBHost:     "localhost",
	DBPort:     5432,
	DBDatabase: "boss_plugin_daemon",
	DBSslMode:  "disable",
}
...
func TestAcceptConnection(t *testing.T) {
	if cache.InitRedisClient("0.0.0.0:6379", "", "bossai123456", false, 0) != nil {
