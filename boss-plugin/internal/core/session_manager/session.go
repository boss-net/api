...
type Session struct {
	...
	backwardsInvocation boss_invocation.BackwardsInvocation `json:"-"`
...
type NewSessionPayload struct {
	...
	Action                 access_types.PluginAccessAction        `json:"action"`
	Declaration            *plugin_entities.PluginDeclaration     `json:"declaration"`
	BackwardsInvocation    boss_invocation.BackwardsInvocation    `json:"backwards_invocation"`
...
func (s *Session) BindBackwardsInvocation(backwardsInvocation boss_invocation.BackwardsInvocation) {
	s.backwardsInvocation = backwardsInvocation
}

func (s *Session) BackwardsInvocation() boss_invocation.BackwardsInvocation {
