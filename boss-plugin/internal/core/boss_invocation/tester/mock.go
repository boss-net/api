...
import (
	...
	jsonschema "github.com/boss-net/api/boss-plugin/internal/utils/json_schema"
...
type MockedBossInvocation struct{}

func NewMockedBossInvocation() boss_invocation.BackwardsInvocation {
	return &MockedBossInvocation{}
}

func (m *MockedBossInvocation) InvokeLLM(payload *boss_invocation.InvokeLLMRequest) (*stream.Stream[model_entities.LLMResultChunk], error) {
...
func (m *MockedBossInvocation) InvokeTextEmbedding(payload *boss_invocation.InvokeTextEmbeddingRequest) (*model_entities.TextEmbeddingResult, error) {
...
func (m *MockedBossInvocation) InvokeRerank(payload *boss_invocation.InvokeRerankRequest) (*model_entities.RerankResult, error) {
...
func (m *MockedBossInvocation) InvokeTTS(payload *boss_invocation.InvokeTTSRequest) (*stream.Stream[model_entities.TTSResult], error) {
...
func (m *MockedBossInvocation) InvokeSpeech2Text(payload *boss_invocation.InvokeSpeech2TextRequest) (*model_entities.Speech2TextResult, error) {
...
func (m *MockedBossInvocation) InvokeModeration(payload *boss_invocation.InvokeModerationRequest) (*model_entities.ModerationResult, error) {
...
func (m *MockedBossInvocation) InvokeTool(payload *boss_invocation.InvokeToolRequest) (*stream.Stream[tool_entities.ToolResponseChunk], error) {
...
func (m *MockedBossInvocation) InvokeApp(payload *boss_invocation.InvokeAppRequest) (*stream.Stream[map[string]any], error) {
...
func (m *MockedBossInvocation) InvokeEncrypt(payload *boss_invocation.InvokeEncryptRequest) (map[string]any, error) {
	return payload.Data, nil
}

func (m *MockedBossInvocation) InvokeParameterExtractor(payload *boss_invocation.InvokeParameterExtractorRequest) (*boss_invocation.InvokeNodeResponse, error) {
	resp := &boss_invocation.InvokeNodeResponse{
...
func (m *MockedBossInvocation) InvokeQuestionClassifier(payload *boss_invocation.InvokeQuestionClassifierRequest) (*boss_invocation.InvokeNodeResponse, error) {
	return &boss_invocation.InvokeNodeResponse{
		ProcessData: map[string]any{},
		Outputs: map[string]any{
...
func (m *MockedBossInvocation) InvokeSummary(payload *boss_invocation.InvokeSummaryRequest) (*boss_invocation.InvokeSummaryResponse, error) {
	return &boss_invocation.InvokeSummaryResponse{
		Summary: payload.Text,
	}, nil
}

func (m *MockedBossInvocation) UploadFile(payload *boss_invocation.UploadFileRequest) (*boss_invocation.UploadFileResponse, error) {
	return &boss_invocation.UploadFileResponse{
		URL: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
	}, nil
}

func (m *MockedBossInvocation) FetchApp(payload *boss_invocation.FetchAppRequest) (map[string]any, error) {
