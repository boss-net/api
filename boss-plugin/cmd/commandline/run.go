...
import (
	"github.com/boss-net/api/boss-plugin/cmd/commandline/run"
	"github.com/spf13/cobra"
)

/*
 Test is a very important component of Boss plugins, to ensure every plugin is working as expected
 ...
 It makes things easier, the command should be `run`, instead of `test`, user could use `boss plugin run <plugin_id>`
