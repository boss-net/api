...
var (
	...
	rootCommand = &cobra.Command{
		Use:   "boss",
		Short: "Boss",
		Long:  "Boss is a cli tool to help you develop your Boss projects.",
	}
	...
	versionCommand = &cobra.Command{
		Use:   "version",
		Short: "Version",
		Long:  "Show the version of boss cli",
...
func init() {
	...
	rootCommand.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.boss.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".boss" (without extension).
