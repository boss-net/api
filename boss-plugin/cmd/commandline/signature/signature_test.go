...
import (
	...
	"github.com/boss-net/api/boss-plugin/pkg/plugin_packager/signer"
	"github.com/stretchr/testify/assert"
)

//go:embed testdata/dummy_plugin.bosspkg
...
func TestSignAndVerify(t *testing.T) {
	...
	dummyPluginPath := filepath.Join(tempDir, "dummy_plugin.bosspkg")
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			testPluginPath := filepath.Join(tempDir, "test_plugin_"+tt.name+".bosspkg")
...
// TestVerifyUnsigned tests verification of an unsigned bosspkg file
...
// TestVerifyTampered tests verification of a tampered signed bosspkg file
func TestVerifyTampered(t *testing.T) {
	...
	tamperedPluginPath := filepath.Join(tempDir, "tampered_plugin.signed.bosspkg")
...
/*
Formerly, the plugin is all signed by boss-net but has no authorized category
*/
