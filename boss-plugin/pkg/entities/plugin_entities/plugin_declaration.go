...
type PluginMeta struct {
	...
	MinimumBossVersion *string          `json:"minimum_boss_version" yaml:"minimum_boss_version"`
}
...
type PluginDeclarationWithoutAdvancedFields struct {
	...
	Type        manifest_entities.BossManifestType `json:"type" yaml:"type,omitempty" validate:"required,eq=plugin"`
