...
type GithubDependency struct {
	...
	// 1. owner/repo/1.0.0/aaa.bosspkg
	// 2. owner/repo/1.0.0/*.bosspkg
	// 3. owner/repo/1.x.x/aaa.bosspkg
	// 4. owner/repo/^1.0.0/aaa.bosspkg
	// 5. owner/repo/~1.0.0/aaa.bosspkg
	// 6. owner/repo/1.0.0-2.0.0/aaa.bosspkg
	// 7. owner/repo/1.0.0-beta/aaa.bosspkg
...
type PackageDependency struct {
	// refers to the path of bosspkg file in assets
