...
import (
	"github.com/boss-net/api/boss-plugin/internal/core/license/private_key"
...
/*
	BossPlugin is a file type that represents a plugin, it's designed to based on zip file format.
