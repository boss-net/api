...
def test_run():
    ...
    pool.add(["pe", "list_output"], ["boss-1", "boss-2"])
    ...
    def tt_generator(self):
        return NodeRunResult(
            ...
            inputs={"iterator_selector": "boss"},
            outputs={"output": "boss 123"},
        )
    ...
    with patch.object(TemplateTransformNode, "_run", new=tt_generator):
        ...
        for item in result:
            ...
            if isinstance(item, RunCompletedEvent):
                ...
                assert item.run_result.outputs == {"output": ["boss 123", "boss 123"]}
