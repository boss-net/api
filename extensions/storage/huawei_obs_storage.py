...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = boss_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=boss_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=boss_config.HUAWEI_OBS_SECRET_KEY,
            server=boss_config.HUAWEI_OBS_SERVER,
        )
