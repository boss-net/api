...
class TencentCosStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = boss_config.TENCENT_COS_BUCKET_NAME
        config = CosConfig(
            Region=boss_config.TENCENT_COS_REGION,
            SecretId=boss_config.TENCENT_COS_SECRET_ID,
            SecretKey=boss_config.TENCENT_COS_SECRET_KEY,
            Scheme=boss_config.TENCENT_COS_SCHEME,
        )
