...
class VolcengineTosStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = boss_config.VOLCENGINE_TOS_BUCKET_NAME
        self.client = tos.TosClientV2(
            ak=boss_config.VOLCENGINE_TOS_ACCESS_KEY,
            sk=boss_config.VOLCENGINE_TOS_SECRET_KEY,
            endpoint=boss_config.VOLCENGINE_TOS_ENDPOINT,
            region=boss_config.VOLCENGINE_TOS_REGION,
        )
