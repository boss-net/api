...
class VersionApi(Resource):
    def get(self):
        ...
        check_update_url = boss_config.CHECK_UPDATE_URL

        result = {
            "version": boss_config.CURRENT_VERSION,
            "release_date": "",
            "release_notes": "",
            "can_auto_update": False,
            "features": {
                "can_replace_logo": boss_config.CAN_REPLACE_LOGO,
                "model_load_balancing_enabled": boss_config.MODEL_LB_ENABLED,
            },
        }
