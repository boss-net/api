                ...
                for i in rs:
                    ...
                    if retrieval_model:
                        if (
                            ...
                            # update google to boss-net/gemini/google etc.
                    ...
                    try:
                        # update provider name append with "boss-net/{provider_name}/{provider_name}"
        ...
        while True:
            ...
            with db.engine.begin() as conn:
                ...
                for i in rs:
                    ...
                    try:
                        # update jina to boss-net/jina_tool/jina etc.
