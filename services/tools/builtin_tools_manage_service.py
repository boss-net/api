...
class BuiltinToolManageService:
        ...
        with db.session.no_autoflush:
            ...
            for provider_controller in provider_controllers:
                try:
                    ...
                    if is_filtered(
                        include_set=boss_config.POSITION_TOOL_INCLUDES_SET,  # type: ignore
                        exclude_set=boss_config.POSITION_TOOL_EXCLUDES_SET,  # type: ignore
    ...
    def _fetch_builtin_provider(provider_name: str, tenant_id: str) -> BuiltinToolProvider | None:
        try:
            ...
            if provider_id_entity.organization != "boss-net":
                provider_obj = (
