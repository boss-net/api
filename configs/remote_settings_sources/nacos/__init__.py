...
class NacosSettingsSource(RemoteSettingsSource):
    ...
    def async_init(self):
        data_id = os.getenv("BOSS_ENV_NACOS_DATA_ID", "boss-api-env.properties")
        group = os.getenv("BOSS_ENV_NACOS_GROUP", "nacos-boss")
        tenant = os.getenv("BOSS_ENV_NACOS_NAMESPACE", "")
