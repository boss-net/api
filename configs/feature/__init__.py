...
class MarketplaceConfig(BaseSettings):
    ...
    MARKETPLACE_API_URL: HttpUrl = Field(
        ...
        default=HttpUrl("https://marketplace.boss.ai"),
    )
...
class RagEtlConfig(BaseSettings):
    ...
    ETL_TYPE: str = Field(
        description="RAG ETL type ('boss' or 'Unstructured'), default to 'boss'",
        default="boss",
    )
